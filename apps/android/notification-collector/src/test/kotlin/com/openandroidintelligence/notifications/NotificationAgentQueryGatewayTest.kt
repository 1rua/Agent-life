...
class NotificationAgentQueryGatewayTest {
    ...
    private fun assertFailed(
        result: com.openandroidintelligence.core.model.NotificationCaptureResult,
        reason: String,
        revision: ULong,
    ) {
...
private class CountingNotificationCollector(
    ...
    override suspend fun captureOnDemand(
        request: com.openandroidintelligence.core.model.OnDemandNotificationRead,
    ): com.openandroidintelligence.core.model.NotificationCaptureResult {
        captureCount += 1
