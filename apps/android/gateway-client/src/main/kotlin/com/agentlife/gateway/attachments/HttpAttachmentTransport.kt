...
class HttpAttachmentTransport(
    ...
    override suspend fun uploadContent(
        ...
        val response = http.execute(
            SignedGatewayRequest(
                method = "PUT",
                target = "/agent-life/v2/attachments/$attachmentId/content",
    ...
    override suspend fun commit(attachmentId: String) {
        val response = http.execute(
            SignedGatewayRequest(
                method = "POST",
                target = "/agent-life/v2/attachments/$attachmentId/commit",
                headers = JSON_HEADERS,
    ...
    private fun stringField(response: com.agentlife.gateway.http.GatewayResponse, name: String): String? {
