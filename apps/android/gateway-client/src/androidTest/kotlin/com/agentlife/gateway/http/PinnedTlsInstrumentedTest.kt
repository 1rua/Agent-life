...
class PinnedTlsInstrumentedTest {
    ...
    fun httpsOnlyFactoryRejectsPlainHttp() {
        ...
        val failure = runCatching { factory.open(URL("http://gateway.example.com/agent-life/v2")) }
            .exceptionOrNull()
    ...
    fun connectTimeoutsAreBoundedAndRedirectsAreNotFollowed() {
        val connection = HttpsConnectionFactory().open(URL("https://gateway.example.com/agent-life/v2"))
