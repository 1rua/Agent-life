...
import com.agentlife.conversation.attachment.AttachmentSubmissionGate
import com.agentlife.conversation.model.AttachmentDraft
import com.agentlife.conversation.model.AttachmentDraftId
import com.agentlife.conversation.model.AttachmentState
import com.agentlife.conversation.model.SubmitIntentId
import com.agentlife.conversation.ports.AttachmentDraftCoordinator
import com.agentlife.conversation.ports.AttachmentDraftState
import com.agentlife.conversation.ports.CancelSubmissionResult
import com.agentlife.conversation.ports.LocalAttachmentSelection
import com.agentlife.conversation.ports.PendingSubmissionIntent
import com.agentlife.gateway.attachments.AttachmentUploader
import com.agentlife.gateway.attachments.SelectedAttachment
...
class GatewayAttachmentDraftCoordinator(
    ...
    override suspend fun armSubmission(draftId: String, revision: Long): PendingSubmissionIntent {
        val intent = com.agentlife.conversation.attachment.PendingSubmissionIntent(
        ...
        return PendingSubmissionIntent(
            ...
            clientMessageId = com.agentlife.conversation.model.ClientMessageId("cmsg_${draftId}_$revision"),
