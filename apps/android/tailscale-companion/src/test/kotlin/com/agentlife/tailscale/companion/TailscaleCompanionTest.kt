...
class TailscaleCompanionTest {
    ...
    fun companionProtocolContainsNoGatewayCredentialFields() {
        ...
        val candidates = listOf(
            File("apps/android/companion-bridge/src/main/aidl/com/agentlife/companion/ICompanionTransport.aidl"),
            File("../companion-bridge/src/main/aidl/com/agentlife/companion/ICompanionTransport.aidl"),
            File("../../companion-bridge/src/main/aidl/com/agentlife/companion/ICompanionTransport.aidl"),
        )
