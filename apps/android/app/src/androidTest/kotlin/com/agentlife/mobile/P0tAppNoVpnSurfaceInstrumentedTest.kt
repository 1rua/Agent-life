...
/**
 * Real-app on-device audit: com.agentlife.mobile (the shipped app APK) must
...
class P0tAppNoVpnSurfaceInstrumentedTest {
    ...
    private val appPackage = "com.agentlife.mobile"
    ...
    fun appHasNoVpnServiceComponentAndNoBindVpnPermission() {
        ...
        assertFalse(
            "com.agentlife.mobile must not request BIND_VPN_SERVICE",
        ...
        assertEquals(
            "com.agentlife.mobile must register no VpnService implementation",
            0,
            vpnServices.size,
        )
    }
